...
> **_NOTE:_** Pre-build modules are available at [GitHub](https://github.com/ConSol/apache_mod_prometheus_status/releases)
...
Read more at [prometheus.io](https://prometheus.io/docs/practices/naming/#labels) and
[robustperception.io](https://www.robustperception.io/cardinality-is-key)

#### PrometheusStatusLabelValues

Set label values separated by semicolon. You can use the apache log format here.
...
See [httpd.apache.org](http://httpd.apache.org/docs/current/mod/mod_log_config.html#formats) for a
full list of available variables.

#### PrometheusStatusTmpFolder

Set the folder where the inter process communication socket will be created in.
...
- `Apache Module Development` - [httpd.apache.org](https://httpd.apache.org/docs/current/developer/modguide.html)
- `Apache API docs` - [ci.apache.org](https://ci.apache.org/projects/httpd/trunk/doxygen/)
